...
{
    public partial class DbSetAndModelsAdded : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Painting_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartPaintings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CartPaintings_Carts_CartId",
                        column: x => x.CartId,
                        principalTable: "Carts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartPaintings_Painting_PaintingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartPaintings_PaintingId",
                table: "CartPaintings",
                column: "PaintingId");
